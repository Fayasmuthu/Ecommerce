...
! function() {
    ...
    null != (r = document.querySelector(".navbar-sticky")) && (r.classList, t = r.offsetHeight, window.addEventListener("scroll", function(e) {
        ...
        function() {
            for (var e = document.querySelectorAll(".file-drop-area"), t = 0; t < e.length; t++) ! function() {
                ...
                e[t].querySelector(".file-drop-btn").addEventListener("click", function() {
                    ...
                    n.files && n.files[0] && ((e = new FileReader).onload = function(e) {
                        var t, e = e.target.result,
                            r = n.files[0].name;
                        o.innerHTML = r, e.startsWith("data:image") ? ((t = new Image).src = e, t.onload = function() {
                            a.className = "file-drop-preview img-thumbnail rounded", a.innerHTML = '<img src="' + t.src + '" alt="' + r + '">'
                        }) : e.startsWith("data:video") ? (a.innerHTML = "", a.className = "", a.className = "file-drop-icon ci-video") : (a.innerHTML = "", a.className = "", a.className = "file-drop-icon ci-document")
            ...
            updateURL: !1
        }), null != (a = document.querySelector(".btn-scroll-top")) && (o = parseInt(600, 10), window.addEventListener("scroll", function(e) {
        ...
        function() {
            ...
            if (i.length)
                for (var e = 0; e < i.length; e++) ! function(r) {
                    for (var n = i[r].querySelectorAll(".product-gallery-thumblist-item:not(.video-item)"), o = i[r].querySelectorAll(".product-gallery-preview-item"), e = i[r].querySelectorAll(".product-gallery-thumblist-item.video-item"), t = 0; t < n.length; t++) n[t].addEventListener("click", a);
        ...
        function() {
            ...
            if (null != e)
                for (var u = 0; u < e.length; u++) {
                    var t = function() {
                        var t, r, n, o, a = e[u].dataset.countdown,
                        ...
                        setInterval(function() {
                            var e = (new Date).getTime(),
                                e = parseInt((a - e) / 1e3);
                            0 <= e && (t = parseInt(e / 86400), e %= 86400, r = parseInt(e / 3600), e %= 3600, n = parseInt(e / 60), e %= 60, o = parseInt(e), null != l && (l.innerHTML = parseInt(t, 10)), null != i && (i.innerHTML = r < 10 ? "0" + r : r), null != c && (c.innerHTML = n < 10 ? "0" + n : n), null != s && (s.innerHTML = o < 10 ? "0" + o : o))
                        }, 1e3)
                    }();
        ...
        function() {
            ...
            if (0 !== e.length || 0 !== t.length || 0 !== a.length) {
                var l, r = document.head || document.getElementsByTagName("head")[0],
                    i = document.createElement("style");
                r.appendChild(i);
                for (var n = 0; n < e.length; n++) {
                    var c, s = JSON.parse(e[n].dataset.lineChart),
        ...
        function() {
            ...
            if (null !== e) {
                ...
                var i = function(e, t, r, n, o) {
                    ...
                    var i = "callback";
                    window[i] = function(e) {
                        delete window[i], document.body.removeChild(l), t.innerHTML = n, "success" == e.result ? (r.classList.remove("is-invalid"), r.classList.add("is-valid"), o.classList.remove("status-error"), o.classList.add("status-success"), o.innerHTML = e.msg, setTimeout(function() {
        ...
        function() {
            for (var a = document.querySelectorAll(".range-slider"), l = 0; l < a.length; l++) ! function() {
        ...
        function() {
            for (var e = document.querySelectorAll(".widget-filter"), t = 0; t < e.length; t++)(function() {
        ...
        function() {
            for (var o = document.querySelectorAll('[data-bs-toggle="select"]'), a = 0; a < o.length; a++) ! function() {
                for (var e = o[a].querySelectorAll(".dropdown-item"), t = o[a].querySelector(".dropdown-toggle-label"), r = o[a].querySelector('input[type="hidden"]'), n = 0; n < e.length; n++) e[n].addEventListener("click", function(e) {
                    e.preventDefault();
...
$(document).ready(function() {
    ...
    var rangeSliderValue = [
        ...
        document.querySelector('.range-slider-value-max')
    ];

    rangeSlider.noUiSlider.on('update', function(values, handle) {
        rangeSliderValue[handle].value = values[handle];
    });

    // Ajax call when the range slider values change
    rangeSlider.noUiSlider.on('change', function() {
        var minPriceValue = rangeSliderValue[0].value;
        var maxPriceValue = rangeSliderValue[1].value;
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.ajax-product-list-container').html(response.data);
            },
